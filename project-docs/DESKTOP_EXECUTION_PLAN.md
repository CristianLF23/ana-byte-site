...
Validação publicada em 24/09: o build do GitHub Pages para `2ef3c94` concluiu com sucesso. HTML, CSS, JavaScript e quatro WebP desktop responderam com HTTP 200 em `https://cristianlf23.github.io/ana-byte-site/`. O percurso desktop de ida e volta foi gravado no URL público em 1440 × 900, sem erros de JavaScript; os textos desktop em inglês e alemão foram conferidos. As quatro cenas mobile publicadas foram comparadas com o código local nos tamanhos 320 × 568 e 390 × 844 e tiveram 0 pixels diferentes.
